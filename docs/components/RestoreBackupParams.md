...
| `backupPreset` | String | 否 | | 页面下拉值，如 `laion_768d_2.5m` / `laion_768d_8m`；后端按当前环境自动解析 backupId |
...
```json
{"RestoreBackupParams_0": {"backupPreset": "laion_768d_2.5m", "restorePolicy": 1}}
```
...
|--------|------|--------|-----:|-------:|----------|----------------|
| `laion_768d_2.5m` | `awswest` | `laion` | 768 | 2500000 | `backup11_6a5e6e322049eb5` | `in01-d97eed4bad83877` |
