...
public class GlobalClusterUtils {
            ...
            try {
                ...
                if (attempt < MAX_RETRIES) {
                    ...
                    try {
                        ...
                        throw new CustomException(CustomExceptionCode.INTERRUPTED,
                                "Interrupted while fetching global topology", ie);
                    }
                }
            }
        }
        throw new CustomException(CustomExceptionCode.GLOBAL_TOPOLOGY_ERROR,
                "Failed to fetch global topology after " + MAX_RETRIES + " attempts", lastException);
    }
    ...
    static GlobalTopology parseTopologyResponse(String responseBody) {
        ...
        if (code != 0) {
            ...
            throw new CustomException(CustomExceptionCode.GLOBAL_TOPOLOGY_ERROR,
                    "Global topology API returned error code " + code + ": " + message);
        }
