    ...
    public static String doPost(String url,Map<String, String> headers,Map<String, Object> param) {
        ...
        try {
            ...
            if (param != null) {
                ...
                // 模拟表单
                //UrlEncodedFormEntity custom.entity = new UrlEncodedFormEntity(param, "utf-8");
                Gson gson=new Gson();
                HttpEntity entity1=new StringEntity(gson.toJson(param),"utf-8");
...
//            log.info("=====响应参数:"+response);
    ...
    public static String doPut(String url, Map<String, String> param,Map<String,String> headers) {
        ...
        try {
            ...
            if (headers != null) {
                Set<String> keys = headers.keySet();
                for (Map.Entry<String, String> entrdy : headers.entrySet()) {
                    httpPut.addHeader(entrdy.getKey(), entrdy.getValue());
                    //System.out.println("headers:" + entrdy.getKey() + ",值" + entrdy.getValue());
                }
    ...
    public static String doPut(String url, Map<String,String> headers,String json) {
        // 创建Httpclient对象
        CloseableHttpClient httpclient = HttpClients.createDefault();
        String resultString = "";
        CloseableHttpResponse response = null;
